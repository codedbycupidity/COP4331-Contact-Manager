...
• Your web app must reside on a remote server. (Not a computer in your basement.)
...
• All members must participate in the presentation. Not just saying their name, but making
...
# API
• You will need to use Swagger Hug (swagger.io) to document and test your API.
